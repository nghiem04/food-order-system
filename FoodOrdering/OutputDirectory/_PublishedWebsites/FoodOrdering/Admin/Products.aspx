<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="FoodOrdering.Admin.Products" %>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                                                            ...
                                                            ValidationExpression="^([1-9]\d*|0)$" ControlToValidate="txtQuantity" ForeColor="Red">
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                </div>
                                                <div class="form-group">
