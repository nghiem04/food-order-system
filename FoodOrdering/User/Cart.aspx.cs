    ...
    public partial class Cart : System.Web.UI.Page
    {
        ...
        protected void rCartItem_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            if (e.CommandName == "checkout")
            {
                ...
                {
                    lblMsg.Visible = true;
                    lblMsg.Text = "Item <b>'" + pName + "'</b>  is currently out of stock or the quantity requested exceeds availability. Please reduce the quantity or check back later for restocks.";
